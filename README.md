...
TOML 1.0.0-rc.1 已经发布。我们认为 TOML 现在应该非常稳定了，并且除非足够紧要，TOML 1.0.0 将不会出现变动。强烈建议所有的实现都着手兼容 1.0.0 候选版并提供反馈，以便简化发布时迁移到 1.0.0 的工作。  
...
出于可读性的目的，你可以用空格字符替代日期和时刻中间的 T（RFC 3339 的第 5.6 节中允许了这样做）。  
